...
class __TwigTemplate_f9e283f0ee59583505c0d5ed50915dc5 extends Template
{
    private $source;
    private $macros = [];
   ...
   <div class=\"buttons-bar d-flex py-2\">
      <div class=\"col ";
        ...
        if ( !twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isNewItem", [], "method", false, false, false, 47)) {
            ...
            // line 49
            echo "            ";
            if ((twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isNotSolved", [], "method", false, false, false, 49) && (($context["default_action_data"] ?? null) != false))) {
                // line 50
                echo "               ";
               ...
               ";
                ...
                echo "</span>
                  ...
                  ";
                // line 62
                $context["main_actions_itemtypes"] = twig_array_filter($this->env, ($context["timeline_itemtypes"] ?? null), function ($__v__, $__k__) use ($context, $macros) { $context["v"] = $__v__; $context["k"] = $__k__; return ( !twig_get_attribute($this->env, $this->source, ($context["v"] ?? null), "hide_in_menu", [], "any", true, true, false, 62) || (twig_get_attribute($this->env, $this->source, ($context["v"] ?? null), "hide_in_menu", [], "any", false, false, false, 62) != true)); });
                // line 63
                echo "                  ";
                if ((twig_length_filter($this->env, ($context["main_actions_itemtypes"] ?? null)) > 1)) {
                    ...
                    if ((($context["timeline_btn_layout"] ?? null) == twig_constant("Config::TIMELINE_ACTION_BTN_SPLITTED"))) {
                        ...
                        foreach ($context['_seq'] as $context["action"] => $context["timeline_itemtype"]) {
                            // line 66
                            echo "                        ";
                            if ((twig_get_attribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, false, 66) > 0)) {
                                // line 67
